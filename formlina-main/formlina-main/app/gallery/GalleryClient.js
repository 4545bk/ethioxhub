        ...
        <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-teal-800 to-teal-600 py-8 px-4 sm:px-6 lg:px-12">
          ...
          <div className="max-w-7xl mx-auto text-center mb-8">
            <p className="text-white text-base sm:text-lg leading-relaxed">
              ...
              <a
                href="https://t.me/your_telegram_handle" // Replace with your Telegram link
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block py-1 px-3 bg-teal-500 text-white rounded-full text-xs sm:text-sm font-medium hover:bg-teal-600 transition-all duration-300"
              >
                Telegram
              </a>
            </p>
            <p className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-br from-indigo-900 via-teal-800 to-teal-600 mt-4">
