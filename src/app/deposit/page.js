        ...
        <div className="min-h-screen bg-dark-950">
            ...
            <div className="pt-24 pb-12 px-4 sm:px-6 lg:px-8">
                <div className="max-w-2xl mx-auto">
                    <h1 className="text-3xl font-display font-bold text-white mb-2">Deposit Funds</h1>
                    <p className="text-dark-400 mb-8">Upload your payment screenshot to add funds to your account</p>
                    ...
                    >
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            {/* Amount */}
                            <div>
                                <label className="block text-sm font-medium text-dark-300 mb-2">Amount (ETB)</label>
                                <input
                                    type="number"
                                    value={amount}
                            ...
                            {/* Payment Screenshot */}
                            <div>
                                <label className="block text-sm font-medium text-dark-300 mb-2">Payment Screenshot</label>
                                    ...
                                    >
                                        {preview ? (
                                            ...
                                            <div className="text-center">
                                                ...
                                                <p className="text-dark-400 text-sm">Click to upload screenshot</p>
                                            </div>
                                        )}
                                    </label>
                                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label className="block text-sm font-medium text-dark-300 mb-2">Sender Name</label>
                                    <input
                                        type="text"
                                        value={senderName}
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-dark-300 mb-2">Transaction Code</label>
                                    <input
                                        type="text"
