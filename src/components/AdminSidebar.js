    ...
    return (
        <div className="w-64 min-h-screen bg-gray-900 border-r border-gray-800 p-6 flex-shrink-0">
            ...
            <nav className="space-y-2">
                ...
                <Link
                    href="/admin/lina-girls"
                    className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors ${pathname.includes('/lina-girls')
                        ? 'bg-orange-600 text-white'
                        : 'text-gray-400 hover:bg-gray-800 hover:text-white'
                        }`}
                >
